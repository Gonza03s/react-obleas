...
const ObleasCartas = ({ oblea }) => {
  const { eliminarOblea } = useGlobalContext();
  ...
  return (
    <div className="bg-slate-400 p-2 mb-2 border-b-2 border-cyan-400 rounded-lg  ">
          ...
          <div className="grid lg:grid-cols-8 lg:place-items-center ">
            ...
            <div className="hidden lg:flex justify-center items-center ">
              <button
                ...
                className=" bg-red-400 rounded-md p-2 hover:bg-red-500 transition-colors "
              >
                Eliminar
              </button>
            </div>
      ...
      <div className="lg:hidden">
        <button
          onClick={() => eliminarOblea(oblea.id)}
          className=" bg-red-400 rounded-md w-full mt-2 py-2 hover:bg-red-500 transition-colors lg:w-1/5"
        >
          Eliminar
        </button>
      </div>
